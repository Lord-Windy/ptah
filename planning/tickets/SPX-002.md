...
Add the main event loop execution with io_uring submission/completion
processing. This implements the core event loop that will process async I/O
operations and dispatch to PlexItem handlers.
...
The simple timeout operation in this ticket serves as a proof-of-concept for
the handler dispatch mechanism that will be used throughout the system.
