...
Create the basic PlexEventLoop structure with io_uring initialization and
destruction. This establishes the foundation for the async event loop that will
drive all Samplex operations.
...
- [x] Functions implemented:
  - [x] `plex_event_loop_create(PlexRegistry* registry, uint32_t queue_depth)`
  - [x] `plex_event_loop_destroy(PlexEventLoop* loop)`
- [x] Includes proper Apache 2.0 license headers
- [x] io_uring ring properly initialized with configurable queue depth
- [x] Proper cleanup in destroy function
- [x] Code compiles without warnings
- [x] Basic validation test added to main.c
...
- Headers: `apps/spikes/samplex/src/plex_uring.h` (internal use, not
  public API yet)
