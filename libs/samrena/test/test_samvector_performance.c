...
void test_vector_memory_usage_patterns() {
  ...
  } test_cases[] = {{sizeof(char), 50000, "char"},     {sizeof(int), 25000, "int"},
                    {sizeof(double), 12500, "double"}, {sizeof(void *), 20000, "pointer"},
                    {64, 5000, "64-byte struct"},      {256, 2000, "256-byte struct"},
                    {1024, 500, "1KB struct"}};
