...
static void test_pearl_int_set_operations(void) {
    ...
    int_set_pearl *set = int_set_create(16, arena);
    assert(set != NULL);
...
static void test_pearl_long_set_operations(void) {
    ...
    long_set_pearl *set = long_set_create(16, arena);
    assert(set != NULL);
...
static void test_pearl_ptr_set_operations(void) {
    ...
    ptr_set_pearl *set = ptr_set_create(16, arena);
    assert(set != NULL);
...
static void test_pearl_uint_set_operations(void) {
    ...
    uint_set_pearl *set = uint_set_create(16, arena);
    assert(set != NULL);
...
static void test_pearl_ulong_set_operations(void) {
    ...
    ulong_set_pearl *set = ulong_set_create(16, arena);
    assert(set != NULL);
...
static void test_pearl_custom_type_definition(void) {
    ...
    custom_int_set_pearl *set = custom_int_set_create(16, arena);
    assert(set != NULL);
...
static void test_pearl_struct_type_definition(void) {
    ...
    point_set_pearl *set = point_set_create(16, arena);
    assert(set != NULL);
