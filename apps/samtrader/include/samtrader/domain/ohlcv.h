 ...
 */
SamtraderOhlcv *samtrader_ohlcv_create(Samrena *arena, const char *code,
                                       const char *exchange, time_t date,
 ...
 */
SamrenaVector *samtrader_ohlcv_vector_create(Samrena *arena,
 ...
 */
double samtrader_ohlcv_true_range(const SamtraderOhlcv *ohlcv,
                                  double prev_close);
