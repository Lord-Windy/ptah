...
int main() {
  ...
  printf("   Student vector - Size: %zu, Capacity: %zu, Empty: %s\n",
         samrena_vector_Student_size(students), samrena_vector_Student_capacity(students),
         samrena_vector_Student_is_empty(students) ? "Yes" : "No");

  printf("   Point vector - Size: %zu, Capacity: %zu, Full: %s\n",
         samrena_vector_Point3D_size(points), samrena_vector_Point3D_capacity(points),
